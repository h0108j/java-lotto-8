...
public class LottoFactoryTest {
    ...
    public void 로또_생성_성공_테스트_1() {
        LottoFactory lottoFactory = new LottoFactory(new ManualNumberGenerator("3, 6, 1, 2, 5, 4"));
    ...
    public void 로또_생성_실패_테스트_1() {
        LottoFactory lottoFactory = new LottoFactory(new ManualNumberGenerator("6, 1, 2, 5, 4"));
    ...
    public void 로또_생성_실패_테스트_2() {
        LottoFactory lottoFactory = new LottoFactory(new ManualNumberGenerator("3, 3, 1, 2, 5, 4"));
        assertThatThrownBy(() -> lottoFactory.createLotto())
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void 로또_생성_실패_테스트_3() {
        LottoFactory lottoFactory = new LottoFactory(new ManualNumberGenerator("0, 6, 1, 2, 5, 4"));
        assertThatThrownBy(() -> lottoFactory.createLotto())
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void 로또_생성_실패_테스트_4() {
        LottoFactory lottoFactory = new LottoFactory(new ManualNumberGenerator("46, 6, 1, 2, 5, 4"));
        assertThatThrownBy(() -> lottoFactory.createLotto())
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("로또 숫자의 범위는 " + LOTTO_START_INCLUSIVE + "에서 " +  LOTTO_END_INCLUSIVE + " 사이입니다.");
    }
